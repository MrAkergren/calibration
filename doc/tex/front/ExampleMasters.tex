...
% User commands
\title{Kalibrering av ljussensor för \\ Parans solpanel}
%\subtitle{And Perhaps a Subtitle} % Optional
\author{Pär Svedberg\and Oskar Åkergren}
\thesisin{högskoleingenjörsprogrammet för datateknik}
...
\coverfigure{\includegraphics[width=\textwidth,height=0.4\paperheight,keepaspectratio]{figures/panel_fig2_cropped_utkast}}
\covercaption{Parans solpaneler modell SP3 installerade på taket till Centrum för vuxnas lärande i Växjö \\ \textit{Fotograf: Oskar Åkergren}}
