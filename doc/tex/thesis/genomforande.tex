...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_2}
        Metodens andra fas innebar att finna lösningar till de identifierade problemen. Möjliga förslag på lösningar diskuterades för att finna de som ansågs lämpliga att föra vidare till utveckling.
