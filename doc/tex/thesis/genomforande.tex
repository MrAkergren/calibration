...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_1}
        Projektet genomfördes med stöd av den valda metoden och i den första fasen, problemidentifikationsfasen, läggs grunden till projektet. Fas ett strävar till att skapa en grundläggande förståelse till det problem som projektet är satt till att lösa, samt möjliggöra för författarna att fördjupa sig i det rådande forskningsläget inom området.\bigskip

        Detta arbete inleddes genom möten med uppdragsgivaren i syfte att få en enhällig uppfattning om vad företaget efterfrågade och formaliserade de praktiska problem som företaget sökte en lösning till. Vidare var det även i den här fasen som introduktionen till projektets rapport utvecklades för att fastslå vad projektet avsåg att utföra, som ett led i problemidentifieringen. \bigskip
    ...
    \label{sub:steg_2}
        Den andra fasen i arbetet tar vid när projektet har skapat en uppfattning kring vilket problem som ska lösas och vilken forskning som finns på området. I denna fas läggs förslag till hur problemet kan lösas och sedan väljs ett sådant förslag till att föras över till nästa fas, fas tre.
