...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_2}
        Den andra fasen tog vid när projektet hade skapat sig en uppfattning kring vilka problem som skulle lösas och vilken forskning som fanns på områdena. I denna fas lades förslag fram till hur problemen kunde lösas och sedan valdes sådana förslag att föras över till nästa fas, fas tre.
