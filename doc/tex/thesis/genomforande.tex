...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_2}
        Metodens andra fas tar vid när projektet har skapat sig en uppfattning kring vilket problem som ska lösas och vilken forskning som finns inom området. I denna fas läggs förslag till hur problem kan lösas och sedan väljs ett sådant förslag att föras över till nästa fas, fas tre.
