...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_1}
        Projektet genomfördes med stöd av den valda metoden och i den första fasen, problemidentifikationsfasen, lades grunden till projektet. Fas ett strävade efter att skapa en grundläggande förståelse av de problem som projektet avsåg lösa, samt att möjliggöra fördjupning inom områdenas rådande forskningsläge.\bigskip

        I arbetets inledning hölls möten med uppdragsgivaren i syfte att få en enhällig uppfattning om vad företaget efterfrågade och formalisera de praktiska problem till vilka företaget sökte lösning. Vidare var det även i denna fas som introduktionen till projektets rapport utvecklades, som ett ytterligare led i problemidentifieringen och att fastslå vad projektet avsåg utföra. \bigskip
