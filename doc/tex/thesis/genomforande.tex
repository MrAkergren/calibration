...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_3}
        ...
        \begin{table}[ht]
            \caption{\label{tab:algoritm_steg}Jämförelse av de olika algoritmiterationernas antal söksteg}
            \centering
            \begin{threeparttable}
            \begin{tabular}{@{}>{\small}m{1.6cm}>{\small}m{1.6cm}>{\small}m{1.6cm}>{\small}m{1.6cm}>{\small}m{1.6cm}>{\small}m{1.6cm}>{\small}m{1.6cm}@{}}
            \toprule
                                        & Iteration 1 8 rikt.\tnote{1}     & Iteration 1 4 rikt.\tnote{1} & Iteration 2 8 rikt.\tnote{12} & Iteration 2 4 rikt.\tnote{12} & Iteration 3 8 rikt.\tnote{123} & Iteration 3 4 rikt.\tnote{123}     \\ \midrule
            % Antal steg, medel         & 261           & 163       & 136       & 132       & 79        & 72            \\
            Antal steg \newline median  & 224           & 145       & 127       & 124       & 78        & 71            \\ \bottomrule
            \end{tabular}
            \begin{tablenotes}
                \item \small Varje iteration implementerar ny funktionalitet:
                \item[1] \small Iteration 1: Söker medurs i fyra alternativt åtta riktningar
                \item[2] \small Iteration 2: Undersöker ej redan kontrollerade koordinater
                \item[3] \small Iteration 3: Undersöker först samma riktning som senast lyckad förflyttning
            \end{tablenotes}
            \end{threeparttable}
        \end{table} \bigskip
        ...
        \begin{table}[h]
            ...
            \toprule
            Från        & \multicolumn{1}{l}{\small Till iteration 2} & \multicolumn{1}{l}{\small Till iteration 3} \\ \midrule
            Iteration 1 & 14~\%                                & 51~\%                                \\
            Iteration 2 & -                                    & 43~\%                               
            \end{tabular}
        \end{table}
