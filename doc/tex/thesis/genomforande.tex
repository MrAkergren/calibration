...
\label{sec:genomf_rande}
    ...
    \label{sub:steg_3}
        ...
        \label{ssub:utveckling_av_algoritm}
            ...
            För att testa algoritmen på solpanelen genomfördes först en simpel genomsökning av panelens solintag till en tvådimensionell matris, i syfte att undersöka ifall utformningen av panelens fokuspunkt överensstämmer med projektets antagande i figur~\ref{fig:array}. Resultatet av denna sökning gav olika bilder beroende på vilken av luxmätarna som användes vid sökningen, där en bild inte alls stämde överens med antagandet och en bild som stämde in precis, vilket visas i figur~\ref{fig:luxcomp}.
            För fullständig data av denna sökning, se bilaga~\ref{sec:heatmap}. Projektet beslutade då att endast nyttja den luxmätare som genererade den förväntade fokuspunkten, då inga andra efterforskningar som tidigare gjorts på detta område på panelen, har resulterat i något som liknar bilden i figur~\ref{fig:ada} och att förlita sig till dessa mätningar skulle ge ett lägre ljusflöde från panelen då dess maximum punkt ligger i utkanten av det äkta maximum.
