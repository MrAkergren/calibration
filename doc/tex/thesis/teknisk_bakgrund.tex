...
\label{sec:teknisk_bakgrund}
    ...
    \label{sub:parans_sp3}
        ...
        \label{ssub:ljussensor}
            För att optimera ljusintaget i panelen sitter en ljussensor monterad på panelens front.  Den består utav en ... och har ett gråfilter utanpå för att skydda mot direkt solljus. 
