...
\begin{abstract}
    ...
    \noindent \textbf{Keywords:} calibration, RS-232, serial communication, optical communication, fibre optics, microcontroller, indoors lighting, Parans, light sensor
\end{abstract}
