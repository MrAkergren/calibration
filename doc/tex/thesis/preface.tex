...
\begin{abstract}
    ...
    \noindent \textbf{Keywords:} calibration, serial communication, optical communication, fibre optics, microcontroller, indoors lighting, Parans, light sensor
\end{abstract}
...
\begin{abstract}
    ...
    \noindent \textbf{Nyckelord:} kalibrering, seriell kommunikation, optisk kommunikation, fiberoptik, mikrokontroller, belysning, Parans, ljussensor
\end{abstract}
