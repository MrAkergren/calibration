...
\begin{abstract}
    ...
    % Result
    Resultaten av projektet var en mjukvarulösning som kalibrerar panelen och två förslag på lösningar gällande kommunikationen, där det rekommenderades att använda panelens egna fiberkablar som datamedium. \medskip
