...
\begin{document}
\maketitle
\vspace{-0.5cm}Denna rapport är den skriftliga delen för opponering av examensarbete och avser rapporten \emph{Incorporating 3D web simulation in the transport industry, Web application constructed with WebGL and AngularJS} skriven av \emph{Mattias Isene} och \emph{Mathias Karlgren}
\input{hiss}
\end{document}